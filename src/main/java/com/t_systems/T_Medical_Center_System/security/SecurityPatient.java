...
public class SecurityPatient implements UserDetails {
    ...
    public SecurityPatient(String username, String password, List<SimpleGrantedAuthority> authorities, boolean isActive) {
    ...
    public static UserDetails fromPatient(Patient patient){
        return new org.springframework.security.core.userdetails.User(
                patient.getEmail(), patient.getPassword(),
                patient.getStatus().equals(Status.ACTIVE),
                patient.getStatus().equals(Status.ACTIVE),
                patient.getStatus().equals(Status.ACTIVE),
                patient.getStatus().equals(Status.ACTIVE)
        );
